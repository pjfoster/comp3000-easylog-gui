      ...
      */
      ...
      while (true) {
    	  ...
    	  if (line != null) { 
    		  ...
    		  // System.out.println("FILE: " + filename[filename.length - 1]);
    		  newLog.add(new StringField("filename", filename[filename.length - 1], Field.Store.YES));
    		  // newLog.add(TIMESTAMP?)
    		  // newLog.add(PROCESS ID)
    		  newLog.add(new TextField("contents", line, Field.Store.YES));
    		  addDocToIndex(writer, newLog, file);
    		  counter++;
    	  }
    	  else break;
